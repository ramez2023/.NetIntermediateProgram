    ...
    public class E3SAndOperatorSupportTests
    {
        ...
        public void TestAndQueryable()
        {
            ...
            Expression<Func<IQueryable<EmployeeEntity>, IQueryable<EmployeeEntity>>> expression
                = query => query.Where(e =>
                    e.Workstation == "EPRUIZHW006" && e.Manager.StartsWith("John"));
            /*
            ...
            var expected = new FtsQueryRequest()
            {
            ...
            var translated = translator.TranslateToFts(expression);

            Assert.Equal(translated, JsonConvert.SerializeObject(expected.Statements));
        }
